...
public class TestGeneratorRuleModelInheritance {
	...
	public static void main(String[] args) {
		...
		// this class was used to test and print the RMI Generated Code
		...
		// test - generate positiveAndNegativeRules (1 rule, 1 Term, 1 positive, 1
		// negative)
		...
		// test - generate positiveAndNegativeRules (1 rule, 1 Term, 3 positive, 3
		// negative)
		...
		// test - generate rulesWithNonRelationalAtoms (1 rule, 1 Terms, 1
		// relationalAtom, 1 nonRelationalAtom)

		System.out
				.println("generate Annotations with facts (1 rule, 1 Terms, 1 relationalAtom, 1 nonRelationalAtom)\n");
